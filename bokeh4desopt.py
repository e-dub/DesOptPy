...
for i in range(len(g[0])):
    gConv.line(
        it, g[:, i], legend_label=gLabels[i], color=colorList[i], line_width=2
    )
...
# Layout of sheet
title = Div(
    text='<h1 style="text-align: center">Design optimization monitoring</h1>'
)
headerConvPlot = Div(
    text='<h2 style="text-align: center">Convergence plots</h2>'
)
